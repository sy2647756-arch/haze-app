...
class HealingPage extends StatelessWidget {
  ...
  static const _items = <(String, String, String)>[
    (
      '2-min Meditation',
      'assets/healing/meditation.png',
      'Quick breathing, instant calm.',
    ),
    (
      '12h Calm Drawer',
      'assets/healing/calm_drawer.png',
      'Lock impulses, reply later.',
    ),
    (
      'Cognitive Correction',
      'assets/healing/cognitive.png',
      'Spot biases, clear thinking.',
    ),
    (
      'AI Tree Hole & Templates',
      'assets/healing/tree_hole.png',
      'Vent freely, text smartly.',
    ),
    (
      '1-on-1 Therapy',
      'assets/healing/therapy.png',
      'Expert care, deep healing.',
    ),
  ];
  ...
  Widget _card(BuildContext context, int i) {
    final (title, asset, description) = _items[i];
    return GestureDetector(
      onTap: () {
        ...
        if (i == 0) {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const MeditationPage()));
          return;
        }
        if (i == 1) {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const CalmDrawerPage()));
          return;
        }
        if (i == 2) {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (_) => const CognitiveCorrectionPage()),
          );
          return;
        }
        if (i == 3) {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const TreeHolePage()));
          return;
        }
        if (i == 4) {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const CounselingPage()));
          return;
        }
