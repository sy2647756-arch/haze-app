...
void main() {
  testWidgets('v4 onboarding is shown even when the v3 flow was completed', (
    tester,
  ) async {
    SharedPreferences.setMockInitialValues({
      'haze_onboarding_complete_v3': true,
    });
  ...
  testWidgets('returning users still see the opening animation', (tester) async {
    SharedPreferences.setMockInitialValues({
      'haze_onboarding_complete_v4': true,
    });
